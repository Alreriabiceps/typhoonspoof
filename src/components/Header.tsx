...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      id="app-main-header"
      className="h-16 flex-shrink-0 border-b border-zinc-800 bg-zinc-950 px-6 flex items-center justify-between z-10"
    >
      <div className="flex items-center gap-3">
        <div>
          <h1 className="text-sm font-semibold text-zinc-100">
            Typhoon Agency Spoofer
          </h1>
          <p className="text-[10px] text-zinc-500 leading-tight">Made by Benhur</p>
        </div>
        {activeProjectName && (
